...
/*add customized code between this region*/
namespace transform.Daos.Tests.Common
{
	...
	where TDdlBuilder : DdlBuilder, new()
	{
		...
		public void BasicSetUp()
		{
			...
			DaoFactory.Instance.ConnectionStringBuilder = new SqlCeConnectionStringBuilder("transform.Entities", baseDirectory, null);
